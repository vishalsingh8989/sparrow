...
// an enum with our current simple serialization technique.
    ...
    private HashMap<TFullTaskId, Integer>   finishedTasksTime = new HashMap<TFullTaskId, Integer>();
    /**
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    client.sendFrontendMessage(task.appId, task ,finishedTasksTime.get(task), message);
                    LOG.info("TasksFinishedRpcRunnable :  "  + finishedTasksTime.get(task));
    ...
    private class TaskRunnable implements Runnable {
        ...
        public void run() {
            ...
            finishedTasksTime.put(taskId , (int)(System.currentTimeMillis() - taskStart));
